...
def ruleBase(d21, d22): 
    ...
    transformInput2(d22,big,medium,small)    
    calculateMatchingDegreeBrbCnn(1, 1, 1, 1, 1)  
    showActivationWeight()  
    updateBeliefDegree()       
    mut_result = aggregateER_BrbCnn()    
    return mut_result
...
def transformInput1(i,j,k,l):   
    ...
    print("Inside Disj F, transformInput1() Input is ",i,"PM_H ", PM_H,"PM_M ",PM_M," PM_L ",PM_L)
    ...
    if (i >= PM_H): 
        ...
        M1 = 1 - L1  
        H1 = 0.0
    print("Inside Disj F, transformInput1(), H1", H1, "M1 ",M1,"L1 ", L1) 
def transformInput2(i,j,k,l):
    ...
    print("Inside Disj F, transformInput2() Input is ",i) 
    ...
    print("Inside Disj F, transformInput2(), H2", H2, "M2 ",M2,"L2 ", L2) 
...
def aggregateER_BrbCnn():   
    ...
    if (aggregatedBeliefDegreeH + aggregatedBeliefDegreeM + aggregatedBeliefDegreeL) == 1:
        ...
        print("Final mutation factor F under Disj complete assessment is", mf)  
        ...
        print ("Aggregated Belief Degrees for Disj F considering degree of Incompleteness: ")   
