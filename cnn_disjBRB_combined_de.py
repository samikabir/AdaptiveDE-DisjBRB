...
def ruleBase(s,c,r,x):  
    conBelDg = r * 3  
    num1 = 0
    global consequentBeliefDegree 
    consequentBeliefDegree = [1.23] * conBelDg
    
    #global relativeWeight1
    #global relativeWeight2 
    temp_consequentBeliefDegree = [1.32] * conBelDg
    
    for a in range(conBelDg):
        temp_consequentBeliefDegree[a] = x[a]
    
    rules = conBelDg/3
     
    for b in range(rules):
        num1 += temp_consequentBeliefDegree
